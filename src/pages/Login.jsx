...
import { Droplets, Lock, User, Eye, EyeOff, ShieldAlert, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/15 rounded-full filter blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-500/15 rounded-full filter blur-[120px]" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">WaterWatch Central Control</p>
        </div>
