...
import { Droplets, ShieldCheck, AlertTriangle, Layers, Navigation, RefreshCw, Eye, EyeOff } from "lucide-react";
...
const WaterMap = () => {
  ...
  // Fetch Locations & Household Spatial Data
  const fetchData = async () => {
    try {
      ...
      if (houseData.success && Array.isArray(houseData.data)) {
        setHouseholds(houseData.data);
      }
    } catch (err) {
